...
CREATE TABLE IF NOT EXISTS `admin_group` (
  ...
  PRIMARY KEY (`gid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='后台管理群组表' AUTO_INCREMENT=10 ;
...
(1, '系统管理用户组', 0, 0, '12582907', '2014-03-10 05:12:13', 0),
...
(7, '协会管理组', 0, 0, '196281', '2014-05-08 16:49:07', 0),
(8, '企业账号管理组', 0, 2, '12312', '2014-05-09 09:55:42', 0),
(9, '专家管理组', 0, 0, '34944', '2014-05-09 11:51:02', 0);
...
CREATE TABLE IF NOT EXISTS `admin_usergroupmap` (
  ...
  PRIMARY KEY (`mapid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='admin_usergroupmap' AUTO_INCREMENT=70 ;
...
CREATE TABLE IF NOT EXISTS `gatherinfo` (
  ...
  `name` varchar(100) NOT NULL COMMENT '学校名称、唯一、必要',
  `alias` varchar(200) NOT NULL COMMENT ' 别名、',
  `logourl` varchar(200) NOT NULL COMMENT '品牌连接、唯一',
  `province` int(11) NOT NULL COMMENT '省份、唯一、需要',
  `city` int(11) NOT NULL COMMENT '城市、唯一、需要',
  `area` int(11) NOT NULL COMMENT '区域',
  `address` varchar(200) NOT NULL COMMENT '地址',
  `address_note` text NOT NULL COMMENT '地址备注、唯一、不必要',
  `bizarea` varchar(200) NOT NULL COMMENT '商圈',
  `longtitude` double NOT NULL COMMENT '经度坐标、唯一、不必要',
  `latitude` double NOT NULL COMMENT '纬度坐标',
  `telephone` varchar(200) NOT NULL COMMENT '座机电话、必要',
  `telephone_others` varchar(100) NOT NULL COMMENT '其他电话',
  `category1` varchar(200) NOT NULL COMMENT '一级分类、唯一',
  `tag` varchar(200) NOT NULL COMMENT '标签',
  `schooldetail` text NOT NULL COMMENT '简介',
  `isok` int(11) NOT NULL DEFAULT '0' COMMENT '是否完善0未完善、1完善',
  `status` int(11) NOT NULL COMMENT '审核状态0表示等待审核，1未审核',
  PRIMARY KEY (`gid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='数据收集表' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `global_media_types` (
  ...
  `createtime` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`typeid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='资源类型表' AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `parper_ext` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='试卷详情表' AUTO_INCREMENT=6441 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COMMENT='推荐位类型管理' AUTO_INCREMENT=21 ;
...
CREATE TABLE IF NOT EXISTS `sys_dict` (
  ...
  `permission` varchar(64) NOT NULL COMMENT '权限位',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统模块数据字典';

--
-- 转存表中的数据 `sys_dict`
--

INSERT INTO `sys_dict` (`id`, `name`, `permission`) VALUES
(1, '管理员清单', '1'),
(2, '管理员用户组管理', '2'),
(3, '系统数据词典管理', '4'),
(4, '用户列表', '8'),
...
CREATE TABLE IF NOT EXISTS `test_parper` (
  ...
  `createtime` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='试卷表' AUTO_INCREMENT=320 ;
...
CREATE TABLE IF NOT EXISTS `usernews` (
  ...
  PRIMARY KEY (`newsid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='用户消息表' AUTO_INCREMENT=44 ;
...
CREATE TABLE IF NOT EXISTS `user_school` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='学校用户表' AUTO_INCREMENT=8 ;
------------------------
