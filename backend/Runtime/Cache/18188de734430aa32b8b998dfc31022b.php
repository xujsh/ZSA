...
<div class="all" id="all">
	<div class="tishi" id="tishi">
		<span style="display:block;margin-top:96px;margin-left:233px;"> <img src="/images/error.png"></span>
		<span style="display:block;margin-top:30px;text-align:center;color:#e03753;font-size:36px;"><?php echo($error); ?></span>
		<p class="jump">
		页面自动 <a id="href" href="<?php echo($jumpUrl); ?>">点击跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></b>
		</p>
	</div>	
</div>
</body>
